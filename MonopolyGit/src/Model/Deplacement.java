...
public class Deplacement extends Carte {
    ...
    public Deplacement(int numCarte, TypeCarte type, TypeCarreau car, String description) {
    ...
    public void getActionCarte() {
        switch (this.getNumCarte()) {
            case 2:  int newpos = getJoueur().getPosition().getNumCarreau()-3;
            
                    getJoueur().setPosition(getJoueur().getPosition());
                     break;
